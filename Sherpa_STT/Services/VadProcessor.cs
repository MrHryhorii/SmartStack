...
/// Channel 2 for Sherpa-ONNX to transcribe.
///
...
/// • It transfers ownership of each output IMemoryOwner<float> to the Sherpa consumer,
...
public sealed class VadProcessor(string vadModelPath) : IDisposable
{
    ...
    /// Ownership of the rental transfers to the channel consumer (Sherpa).
    /// </summary>
    ...
    {
        // Append a short tail of silence for a clean Sherpa decode.
